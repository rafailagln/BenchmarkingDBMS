...
\legend{Monet cold, Monet warm, Mongo cold, Mongo warm, PostgreSQL cold, PostgreSQL warm, Vertica cold, Vertica warm}
\end{axis}
\end{tikzpicture}
...
\begin{figure}[!ht]
	\begin{tikzpicture}
		...
		\end{axis}
		\end{tikzpicture}
			\caption{PostgreSQL - Zillow 1 (HDD Cache)}
...
\begin{table}[!ht]
    ...
    \resizebox{\textwidth}{!}{
		\begin{tabular}{|l|c|c|c|}
			\hline
			Property & Profile 1 & Profile 2 & Profile 4 \\ \hline
			EXECUTIONPARALLELISM & 1 & 2 & 4 \\ \hline
			MAXCONCURRENCY & 1 & 2 & 4 \\ \hline
			MAXMEMORYSIZE & 100\% & 100\% & 100\% \\ \hline
			MAXQUERYMEMORYSIZE & 100\% & 100\% & 100\% \\ \hline
			PRIORITY & 100 & 100 & 100 \\ \hline
			RUNTIMEPRIORITY & HIGH & HIGH & HIGH \\ \hline
			RUNTIMEPRIORITYTHRESHOLD & 0 & 0 & 0 \\ \hline
			QUEUETIMEOUT & NONE & NONE & NONE \\ \hline
			RUNTIMECAP & NONE & NONE & NONE \\ \hline
		\end{tabular}}
\end{table}
